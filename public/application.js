...
/***/ function(module, exports, __webpack_require__) {
	...
	var onShowHistory = function onShowHistory(event) {
	  event.preventDefault();
	  api.showHistory().then(ui.showSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(id, index, value, status) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(9);
	// const store = require('./store');
	var gameData = __webpack_require__(13);
	...
	var addMove = function addMove(index) {
	  if (board[index] === "") {
	...
	var reset = function reset(event) {
	  ...
	  api.createBoard().then(function (response) {
